  ...
  return (
    <View style={[styles.rowActions, styles.actionBar]}>
      <View style={styles.elemAction}>
        ...
        /> */}
        <EvilIcons style={styles.actionButton} name="comment" size={21} color={theme === "dark" ? "gray" : "#000"} />
      ...
      <View style={styles.elemAction}>
        ...
        /> */}
        <EvilIcons style={styles.actionButton} name="retweet" size={22} color={theme === "dark" ? "gray" : "#000"} />
      ...
      <View style={styles.elemAction}>
        ...
        /> */}
        <EvilIcons style={styles.actionButton} name="heart" size={21} color={theme === "dark" ? "gray" : "#000"} />
      ...
      /> */}
      <EvilIcons style={styles.actionButton} name="share-apple" size={23} color={theme === "dark" ? "gray" : "#000"} />
    </View>
  );
};
      ...
      <View style={styles.row}>
        ...
        <View style={styles.tweetContentContainer}>
          <View style={styles.rowTop}>
            <Text numberOfLines={1} style={[styles.header, { color: theme === "dark" ? "#FFF" : "#000" }]}>
              {tweet.author.name}
            </Text>
          ...
          <Text style={[styles.description, { color: theme === "dark" ? "#FFF" : "#000" }]}>{tweet.fullText}</Text>
          <View style={styles.rowActions}>
            {tweetActions(tweet.retweetCount, tweet.replyCount, tweet.favoriteCount)}
          </View>
        </View>
      </View>
    </View>
